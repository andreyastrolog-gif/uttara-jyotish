 ...
 * ===================================================================== */
const LINKS = {
  booking:         'https://t.me/andreyastrologbot?start=site', // бот записи @andreyastrologbot — все кнопки «Записаться»
  telegram:        'https://t.me/andreyastrolog',          // личный Telegram Андрея — «Написать мне в Telegram»
